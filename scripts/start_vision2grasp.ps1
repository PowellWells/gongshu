...
$workbenchEntry = Join-Path $frontendRoot "apps\gongshu\index.html"
if (-not (Test-Path -LiteralPath $workbenchEntry -PathType Leaf)) {
    throw "Gongshu frontend entry was not found: $workbenchEntry"
}
